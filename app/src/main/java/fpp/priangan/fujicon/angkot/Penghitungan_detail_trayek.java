...
public class Penghitungan_detail_trayek extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_place) {
            ...
            Intent openStep = new Intent(this, Penghitungan_detail_trayek.class);
            startActivity(openStep);
            ...
            Intent openStep = new Intent(this, Tes.class);
            startActivity(openStep);
